...
Window {
    ...
    property int battery_percent: 0
    //    GUI UPDATE (Need to be Modify)
    function gui_update(){

        carinfo.dbus_update() //get data from dbus

        instrumentcluster.left_angle = carinfo.speed+instrumentcluster.left_angle_offset //carinfo.speed = getSpeed /
        instrumentcluster.right_angle = -Math.round((carinfo.battery/100)*180)+instrumentcluster.right_angle_offset
        instrumentcluster.battery_percent= carinfo.battery
    ...
    Rectangle {
        ...
        Image {
            ...
            Text {
                ...
                y: 131
                color: "#f7f2f2"
                text: instrumentcluster.battery_percent//(180-instrumentcluster.right_angle)/180*100
                font.pixelSize: 45
                font.family: "Sarabun"
                font.bold: false
                width: parent.width
